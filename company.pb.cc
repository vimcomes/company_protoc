...
const ::uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::Record, _impl_.company_name_),
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\rcompany.proto\"\213\001\n\006Record\022\032\n\022year_of_fo"
    "undation\030\001 \002(\005\022\025\n\rlegal_address\030\002 \002(\t\022\024\n"
    "\014company_name\030\003 \002(\t\022\025\n\ractivity_type\030\004 \001"
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Record.company_name");
          #endif  // !NDEBUG
        } else {
          goto handle_unusual;
        }
...
::uint8_t* Record::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(
        1, this->_internal_year_of_foundation(), target);
  }
